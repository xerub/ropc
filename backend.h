...
void emit_or(const char *value, const char *addend, int deref0, BOOL swap);
void emit_xor(const char *value, const char *addend, int deref0, BOOL swap);
void emit_and(const char *value, const char *addend, int deref0, BOOL swap);
...
void emit_div(const char *value, const char *multiplier, int deref0);
...
void emit_label(const char *label, BOOL used, BOOL last);
...
int backend_test_gadgets(int verbose);
